...
class ConverterApp(QMainWindow):
    ...
    def _create_video_converter_tab(self):
        ...
        # Pengaturan Format Video
        vid_settings_frame = QFrame()
        vid_settings_frame.setObjectName("ioFrame")
        vid_settings_layout = QHBoxLayout(vid_settings_frame)
        vid_settings_layout.addWidget(QLabel("3. Pilih Format Output Video:"))
        self.vid_format_combo = QComboBox()
        self.vid_format_combo.addItems(["mp4", "mkv", "avi", "mov", "webm", "gif"])
        vid_settings_layout.addWidget(self.vid_format_combo)
        vid_settings_layout.addStretch()
    ...
    def start_video_conversion(self):
        ...
        self.thread = QThread()
        self.worker = VideoConversionWorker(ffmpeg_path, input_path, output_path, out_format)
        self.worker.moveToThread(self.thread)
